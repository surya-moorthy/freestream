...
wss.on("connection", function connection(ws) {
    ...
    ws.on("message", function message(data) {
        ...
        if (message.type == "sender") {
            ...
            if (ws === senderSocket) {
                receiverSocket === null || receiverSocket === void 0 ? void 0 : receiverSocket.send(JSON.stringify({ type: "iceCandidate", message: message.candidate }));
            }
            if (ws === receiverSocket) {
                senderSocket === null || senderSocket === void 0 ? void 0 : senderSocket.send(JSON.stringify({ type: "iceCandidate", message: message.candidate }));
            }
        }
    });
